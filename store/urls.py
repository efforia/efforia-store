...
urlpatterns += patterns(u'',
                        ...
                        url(_(r'^hub/devices'), TemplateView.as_view(template_name='hub/devices.html'), name='devices'),
                        ...
                        url(_(r'^services/opensource'), TemplateView.as_view(template_name='opensource.html'), name='opensource'),
                        url(_(r'^services/cloud'), TemplateView.as_view(template_name='services.html'), name='services'),
                        url(_(r'^services/partners'), TemplateView.as_view(template_name='partners.html'), name='partners'),
                        url(_(r'^services/apps'), TemplateView.as_view(template_name='apps.html'), name='apps'),
                        url(_(r'^services/'), TemplateView.as_view(template_name='about.html'), name='about'),

                        url(_(r'^help/localization'), TemplateView.as_view(template_name='localization.html'), name='localization'),
                        url(_(r'^help/warranty'), TemplateView.as_view(template_name='warranty.html'), name='warranty'),
                        url(_(r'^help/documentation'), TemplateView.as_view(template_name='documentation.html'), name='documentation'),
                        url(_(r'^help/developer'), TemplateView.as_view(template_name='developer.html'), name='developer'),
