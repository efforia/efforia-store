...
urlpatterns += [
    ...
    url(_(r'^hub/server'), TemplateView.as_view(template_name='hub/server.html'), name='server'),
    url(r'^hub/', TemplateView.as_view(template_name='hub/index.html'), name='hub'),

    url(_(r'^tv/eosd'), TemplateView.as_view(template_name='tv/eosd.html'), name='eosd'),
    url(_(r'^tv/mediacenter'), TemplateView.as_view(template_name='tv/mediacenter.html'), name='mediacenter'),
    url(_(r'^tv/videogame'), TemplateView.as_view(template_name='tv/videogame.html'), name='videogame'),
    url(_(r'^tv/'), TemplateView.as_view(template_name='tv/index.html'), name='hubpro'),
